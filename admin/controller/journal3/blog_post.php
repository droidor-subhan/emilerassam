...
class ControllerJournal3BlogPost extends Controller {
	...
	public function all() {
		try {
			...
			$this->renderJson(self::SUCCESS, $this->model_journal3_blog_post->all($filters));
		} catch (Exception $e) {
	...
	public function get() {
		try {
			...
			$this->renderJson(self::SUCCESS, $this->model_journal3_blog_post->get($id));
		} catch (Exception $e) {
			$this->renderJson(self::ERROR, $e->getMessage());
		}
	}
	...
	public function add() {
		try {
			...
			$this->renderJson(self::SUCCESS, $this->model_journal3_blog_post->add($data));
		} catch (Exception $e) {
			$this->renderJson(self::ERROR, $e->getMessage());
		}
	}
	...
	public function edit() {
		try {
			...
			$this->renderJson(self::SUCCESS, $this->model_journal3_blog_post->edit($id, $data));
		} catch (Exception $e) {
			$this->renderJson(self::ERROR, $e->getMessage());
		}
	}
	...
	public function copy() {
		try {
			...
			$this->renderJson(self::SUCCESS, $this->model_journal3_blog_post->copy($id));
		} catch (Exception $e) {
			$this->renderJson(self::ERROR, $e->getMessage());
		}
	}
	...
	public function remove() {
		try {
			...
			$this->renderJson(self::SUCCESS, $this->model_journal3_blog_post->remove($id));
		} catch (Exception $e) {
			$this->renderJson(self::ERROR, $e->getMessage());
		}
	}
