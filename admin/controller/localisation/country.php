...
class ControllerLocalisationCountry extends Controller {
	...
	protected function getForm() {
		...
		if (isset($this->request->post['market_id'])) {
			...
			$data['market_id'] = $country_info['market_id'];
		} else {
			$data['market_id'] = 0;
		}
		...
		if (isset($this->request->post['config_language'])) {
			...
			$data['config_language'] = $country_info['language_id'];
		} else {
			$data['config_language'] = 'en-gb';
		}

		if (isset($this->request->post['config_currency'])) {
			$data['config_currency'] = $this->request->post['config_currency'];
		} elseif (!empty($country_info)) {
			$data['config_currency'] = $country_info['currency_id'];
		} else {
			$data['config_currency'] = 'USD';
		}
		...
		$getCurrencies = $this->model_localisation_market->getMarkets();
		$data['markets'] = $getCurrencies;
