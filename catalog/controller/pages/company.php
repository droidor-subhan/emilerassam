<?php
class ControllerPagesCompany extends Controller {
    public function index() {
        ...
        $data['content'] = $this->model_pages_company->getContent($content_id);
        
        $this->response->setOutput($this->load->view('pages/company', $data));
    }
}
