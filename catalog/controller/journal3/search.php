...
class ControllerJournal3Search extends Controller {
	...
	public function index() {
		...
		if ($category_id) {
			$filter_data_products['filter_category_id'] = $category_id;
		}

		if ($sub_category && $this->journal3->settings->get('searchStyleSearchAutoSuggestSubCategories')) {
			$filter_data_products['filter_sub_category'] = true;
		}
		$results = $this->model_journal3_filter->getProducts($filter_data_products);
